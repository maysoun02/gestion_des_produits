<?php
include_once '../controllers/categoryC.php';

$categoryController = new categoryC;

$abs = $categoryController->AfficherCategory();
?>
<!DOCTYPE html>
<html>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="addcategory.php">Home</a></li>
                <li aria-current="page" class="breadcrumb-item active">Liste des category</li>
              </ol>
            </nav>
          </div>
                  ...
                  <tbody>
                    ...
                    foreach ($abs as $category): ?>
                      ...
                      <td>
                        ...
                        <td>
                        <a class=" btn btn-primary m-1" href="modifiercategory.php?id=<?php echo $category->getId(); ?>" >modifier</a>
