...
$abs = $userController->AfficherAbonnements();
?>
<!DOCTYPE html>
<html>
      ...
      <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/logo.png" alt="Obaju logo"
        ...
        <div id="navigation" class="collapse navbar-collapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a href="addproduct.php" class="nav-link active">Home</a></li>
          ...
          <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li aria-current="page" class="breadcrumb-item active">Liste des utlisateurs</li>
              </ol>
            </nav>
          </div>
