...
$abs = $produitController->AfficherProduit();
?>
<!DOCTYPE html>
<html>
      ...
      <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/logo.png" alt="Obaju logo"
        ...
        <div id="navigation" class="collapse navbar-collapse">
          ...
          <div class="navbar-buttons d-flex justify-content-end">
            ...
            <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="panier.php"
                class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span>Panier</span></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="user.php.php">Home</a></li>
                <li aria-current="page" class="breadcrumb-item active">Liste des produits</li>
              </ol>
            </nav>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <tbody>
                    <?php foreach ($abs as $produit): ?>
                      ...
                      <td>
                        ...
                        <td>
                          <?php echo $produit->getNamep(); ?>
                        </td>
                        <td>
                          <?php echo $produit->getPrice(); ?>
                        </td>
                        <td>
                          <?php echo $produit->getCategoryId(); ?>
                        </td>
