        ...
        <div class="row">
            ...
            <div class="card sidebar-menu">
              ...
              <div class="card-body">
                <ul class="nav nav-pills flex-column"><a href="addproduct.php" class="nav-link active"><i
                      class="fa fa-list"></i> Add Product</a><a href="afficherproduct.php" class="nav-link"><i
                      class="fa fa-heart"></i> List Products</a>
                      </ul>
                      <ul class="nav nav-pills flex-column"><a href="addcategory.php" class="nav-link active"><i
                      class="fa fa-list"></i> Add Category</a><a href="affichercategory.php" class="nav-link"><i
                      class="fa fa-heart"></i> List Category</a>
                      <a href="register.php" class="nav-link">
                      <i
                      class="fa fa-sign-out"></i> Logout</a>
                      <a href="basket.php" class="nav-link"><i
                      class="fa fa-heart"></i> List users</a></ul>
          ...
          <div class="col-lg-9">
            <div class="box">
              ...
              <form method="POST" action="ajout_categoryR.php">
                <h1>Add Category</h1>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="namep">Category Name</label>
