        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li aria-current="page" class="breadcrumb-item active">Add Product to panier</li>
              </ol>
            </nav>
          </div>
          <div class="col-lg-3">
            ...
            <div class="card sidebar-menu">
              ...
              <div class="card-body">
                <ul class="nav nav-pills flex-column"><a href="addpanier.php" class="nav-link active"><i
                      class="fa fa-list"></i> Add Product to panier</a><a href="panier.php" class="nav-link"><i
                      class="fa fa-heart"></i> Panier</a>
          ...
          <div class="col-lg-9">
            <div class="box">
              ...
              <form method="POST" action="ajout_panierR.php">
                <h1>Add Product to panier</h1>
                <div class="form-group">
                  <label for="produit_id">Id product</label>
                  <input type="number" class="form-control" id="produit_id" name="produit_id" >
                </div>
                <div class="form-group">
