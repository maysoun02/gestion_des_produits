...
if (isset($_POST['submit'])) {
    $category = new category($_POST["id"],$_POST["nom"]);
    $abs = new categoryC();
    $abs->modifierCategory($category, $id);

    
        
    echo "<script>window.open('affichercategory.php?id=updateSucceed','_self')</script>";
}
?>
          ...
          <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li aria-current="page" class="breadcrumb-item active">Add Category</li>
              </ol>
            </nav>
          </div>
          <div class="col-lg-3">
            ...
            <div class="card sidebar-menu">
              ...
              <div class="card-body">
                <ul class="nav nav-pills flex-column"><a class="nav-link active"><i
                      class="fa fa-list"></i> Modifier Category</a><a href="affichercategory.php" class="nav-link"><i
                      class="fa fa-heart"></i> List Category</a>
...
$abs = new categoryC();
$list = $abs->afficherCategoryParId($id);
    ...
    ?>
          ...
          <div class="col-lg-9">
            <div class="box">
              ...
              <form method="POST" action="modifiercategory.php?id=<?php echo $id ?>">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="<?php echo $row['nom']; ?>" id="nom" name="nom" required>
                </div>
                <button type="submit" class="btn btn-primary" name="submit">Modifier Category</button>
              </form>
