...
if (isset($_POST['submit'])) {
    $produit = new produit($_POST["id"],$_POST["namep"], $_POST["price"], $_POST["category_id"]);
    $abs = new produitC();
    $abs->modifierProduit($produit, $id);

    
        
    echo "<script>window.open('afficherproduct.php?id=updateSucceed','_self')</script>";
}
?>
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-3">
                      ...
                      <ul class="list-unstyled mb-3">
                        ...
                        <li class="nav-item"><a href="category-right.html" class="nav-link">Category - sidebar right</a>
                        </li>
                        <li class="nav-item"><a href="category-full.html" class="nav-link">Category - full width</a>
                        </li>
                    ...
                    <div class="col-md-6 col-lg-3">
                      ...
                      <ul class="list-unstyled mb-3">
                        ...
                        <li class="nav-item"><a href="customer-order.html" class="nav-link">Order history detail</a>
                        </li>
                        <li class="nav-item"><a href="customer-wishlist.html" class="nav-link">Wishlist</a></li>
                        <li class="nav-item"><a href="customer-account.html" class="nav-link">Customer account / change
                            password</a></li>
                      </ul>
                    </div>
                    <div class="col-md-6 col-lg-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                      ...
                      <ul class="list-unstyled mb-3">
                        ...
                        <li class="nav-item"><a href="text-right.html" class="nav-link">Text page - right sidebar</a>
                        </li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            ...
            <div class="card sidebar-menu">
              ...
              <div class="card-body">
                <ul class="nav nav-pills flex-column"><a class="nav-link active"><i
                      class="fa fa-list"></i> Modifier Product</a><a href="afficherproduct.php" class="nav-link"><i
                      class="fa fa-heart"></i> List Products</a>
...
$abs = new produitC();
$list = $abs->afficherProduitParId($id);
    ...
    ?>
          ...
          <div class="col-lg-9">
            <div class="box">
              ...
              <h3 class="mt-5">Produit</h3>
              <form method="POST" action="modifierproduit.php?id=<?php echo $id ?>">
                <h1>Modifier Product</h1>
                <div class="form-group">
                <label for="id">id</label>
                  <input type="number" class="form-control"  placeholder="<?php echo $row['id']; ?>" id="id" name="id" >
                </div>
                <div class="form-group">
                  <label for="namep">Product Name</label>
                  <input type="text" class="form-control" placeholder="<?php echo $row['namep']; ?>" id="namep" name="namep" required>
                </div>
                <div class="form-group">
                  <label for="price">Price</label>
                  <input type="number" class="form-control" id="price" name="price" placeholder="<?php echo $row['price']; ?>" required>
                </div>
                <div class="form-group">
                  <label for="category_id">Category ID</label>
                  <input type="number" class="form-control" id="category_id" name="category_id" placeholder="<?php echo $row['category_id']; ?>" required>
                </div>
                <button type="submit" class="btn btn-primary" name="submit">Modifier Product</button>
              </form>
